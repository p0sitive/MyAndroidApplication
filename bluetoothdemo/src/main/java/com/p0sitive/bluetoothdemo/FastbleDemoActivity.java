...
/**
 * Created by lihe6 on 2016/12/23.
 */

public class FastbleDemoActivity extends Activity implements View.OnClickListener {
    private static final String TAG = "FastbleDemoActivity";
    ...
    private void connectSpecialDevice(final BluetoothDevice device) {
        progressDialog.show();
        bleManager.connectDevice(device.getName(), 1500, new BleGattCallback() {
            @Override
...
//                                        EditDialog dialog = new EditDialog(FastbleDemoActivity.this);
