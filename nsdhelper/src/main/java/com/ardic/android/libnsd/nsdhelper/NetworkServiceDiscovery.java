...
public class NetworkServiceDiscovery {
    ...
    public void registerService(int port,String NSD_SERVER_TYPE) {
        NsdServiceInfo serviceInfo = new NsdServiceInfo();
        serviceInfo.setServiceName("liveman");
    ...
    private void initializeDiscoveryListener() {
        ...
        mDiscoveryListener = new DiscoveryListener() {
            ...
            public void onServiceLost(NsdServiceInfo serviceInfo) {
                onResolveFailedOrServiceLost(serviceInfo);
            }

            @Override
            public void onServiceFound(NsdServiceInfo serviceInfo) {

                writeServiceInfoIfDebuggingEnabled(serviceInfo);
                if (mNsdManager != null) {
    ...
    public List<NSDService> getServiceList() {
        ...
        // return empty list.
        return new ArrayList<NSDService>();
    }
    ...
    private void onResolveFailedOrServiceLost(NsdServiceInfo serviceInfo){
    ...
    private void writeServiceInfoIfDebuggingEnabled(NsdServiceInfo serviceInfo){
        if (DEBUG) {
